      ...
      <div className="donut-chart-block block">
            <div className="row-chart">
              <div className="donut-chart z-depth-1">
                ...
                <p className="center-date z-depth-1">April<br/><span className="scnd-font-color">2014</span></p>
              </div>
              <div className="donut-chart z-depth-1">
                <div id="porcion1" className="recorte"><div className="quesito data1" os-rel="29"></div></div>
                <div id="porcion2" className="recorte"><div className="quesito data2" os-rel="31"></div></div>
                <div id="porcion3" className="recorte"><div className="quesito data4" os-rel="30"></div></div>
                <div id="porcionFin" className="recorte"><div className="quesito data3" os-rel="10"></div></div>
                <p className="center-date z-depth-1">April<br/><span className="scnd-font-color">2015</span></p>
              </div>
              <div className="donut-chart z-depth-1">
                <div id="porcion1" className="recorte"><div className="quesito data1" os-rel="21"></div></div>
                <div id="porcion2" className="recorte"><div className="quesito data2" os-rel="39"></div></div>
